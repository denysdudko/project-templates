...
SUPPORT_EPIC_SUMMARY = "Поддержка"
SUPPORT_EPIC_PLACEHOLDER_ID = "SUPPORT_EPIC"
SUPPORT_LOG_TASK_SUMMARY = "Журнал поддержки"
SUPPORT_LOG_TASK_PLACEHOLDER_ID = "SUPPORT_LOG_TASK"
SUPPORT_EPIC_DESCRIPTION_TEXT = (
...
def build_support_epic_issues(schema: ProjectSchema) -> tuple[PlannedIssue, PlannedIssue]:
    """Epic "Поддержка" + единственная Task внутри (журнал поддержки),
    создаются ВСЕГДА при экспорте -- без флага и независимо от конкретного
    плана (гиперподдержка после закрытия проекта не описывается WBS/Task
    шаблона, см. CHANGELOG.md). Issuetype -- те же schema.epic_type/
    ...
    epic = PlannedIssue(
        ...
        summary=SUPPORT_EPIC_SUMMARY,
        description=SUPPORT_EPIC_DESCRIPTION_TEXT,
        description_adf={"type": "doc", "version": 1, "content": [_adf_text_paragraph(SUPPORT_EPIC_DESCRIPTION_TEXT)]},
    )
    task = PlannedIssue(
        placeholder_id=SUPPORT_LOG_TASK_PLACEHOLDER_ID,
        issue_type_name=schema.task_type["name"],
        summary=SUPPORT_LOG_TASK_SUMMARY,
        description=SUPPORT_EPIC_DESCRIPTION_TEXT,
...
def build_export_plan(
    ...
    support_epic, support_task = build_support_epic_issues(schema)
